...
ALTER PACKAGE mylib COMPILE DEBUG ABAP_OPTIMIZE_LEVEL=1;

ALTER PACKAGE mylib COMPILE DEBUG ABAP_OPTIMIZE_LEVEL=1 REUSE SETTINGS;

ALTER PACKAGE mylib COMPILE DEBUG BODY ABAP_OPTIMIZE_LEVEL=1 REUSE SETTINGS;
