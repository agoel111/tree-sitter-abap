...
ALTER TRIGGER mytrigger COMPILE DEBUG ABAP_OPTIMIZE_LEVEL=1;

ALTER TRIGGER mytrigger COMPILE DEBUG ABAP_OPTIMIZE_LEVEL=1 REUSE SETTINGS;

ALTER TRIGGER mytigger COMPILE DEBUG ABAP_OPTIMIZE_LEVEL = 1 PLSCOPE_SETTINGS = 'IDENTIFIERS:ALL' REUSE SETTINGS;
