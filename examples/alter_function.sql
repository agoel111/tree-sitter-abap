...
ALTER FUNCTION myfunction COMPILE DEBUG ABAP_OPTIMIZE_LEVEL=1;

ALTER FUNCTION myfunction COMPILE DEBUG ABAP_OPTIMIZE_LEVEL=1 PLSCOPE_SETTINGS = 'IDENTIFIERS:ALL' REUSE SETTINGS;

ALTER FUNCTION myfunction COMPILE ABAP_OPTIMIZE_LEVEL = 1 REUSE SETTINGS;
